...
const storefrontV1 = `name: storefront
...
const storefrontV2 = `name: storefront
description: Web shop with a public storefront, a JSON API, and a background worker
...
const storefrontV3 = `name: storefront
description: Web shop with a public storefront, a JSON API, and a background worker
...
const analyticsV1 = `name: analytics
...
const analyticsV2 = `name: analytics
description: Event ingestion, a scheduler, and a reporting dashboard
